...
import toast, { Toaster } from 'react-hot-toast'; // Kept Toaster here locally
...
try {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 font-['Plus_Jakarta_Sans']">
      {/* LOCAL TOASTER: Since you don't want a global one */}
      <Toaster 
        position="top-center" 
        toastOptions={{
          style: {
...
<div className="z-10 bg-slate-800/50 border border-white/10 p-6 rounded-2xl backdrop-blur-sm">
  ...
  <div className="flex items-center gap-3">
    ...
    {/* ----------------------------------------- */}
    <div>
      <p className="font-bold text-sm text-white">Fawad Ahmed</p>
